  ...
  <v-app id="inspire">
    ...
    <v-content>
      <v-container class="fill-height" fluid>
        <p class="display-2">About the Project</p>

        <v-row>
          <v-col cols="12" sm="6">
            <v-img src="../img/Image_1.jpg" :aspect-ratio="16/9"></v-img>
          </v-col>

          <v-col cols="12" sm="6">
            <v-img src="../img/Image_2.jpg" :aspect-ratio="16/9">
        ...
        <p class="display-1">Used materials and sensors</p>

        <v-row>
          <v-col cols="6" sm="4">
            <v-img src="../img/Image_3.jpg" :aspect-ratio="16/9"></v-img>
          ...
          <v-col cols="6" sm="4">
            ...
            <v-img src="../img/Image_4.jpg" :aspect-ratio="16/9">
              <div class="fill-height bottom-gradient"></div>
            </v-img>
          </v-col>

          <v-col cols="6" sm="4">
            <v-img src="../img/Image_5.jpg" :aspect-ratio="16/9">
        ...
        <p class="display-1">Extra information</p>
        ...
        <p class="display-1">Vives</p>

        <v-row>
          <v-col cols="12" sm="6">
            <v-img src="../img/Image_6.jpg" :aspect-ratio="16/9">
              <div class="fill-height repeating-gradient"></div>
            </v-img>
          </v-col>
          <v-col cols="12" sm="6">
        ...
        <p class="display-1">Our experiences</p>
        <p class="body-1">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita ut ipsum saepe earum, enim rem adipisci quas neque reiciendis impedit, iure inventore,
          totam quod. Molestiae consequuntur quibusdam eveniet ab reprehenderit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae, perferendis
          unde. Aliquid ratione iure, ullam assumenda harum aliquam nihil sapiente sunt voluptatem dignissimos, veniam amet quae voluptatum, itaque fuga esse.
